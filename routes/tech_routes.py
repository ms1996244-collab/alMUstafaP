...
def tech_portal(lang='ar'):
    ...
    for p in projects_raw:
        ...
        projects.append(p)
    return render_template('tech/tech.html', projects=projects)
...
def blog(lang='ar'):
    ...
    for a in articles_raw:
        ...
        articles.append(a)
    return render_template('tech/blog.html', articles=articles)
...
def project_details(id, lang='ar'):
    ...
    return render_template('tech/project_details.html', project=project)
...
def article_details(id, lang='ar'):
    ...
    return render_template('tech/article_details.html', article=article)
